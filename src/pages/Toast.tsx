...
export default function Toast() {
  ...
  const buttonClick = async () => {
    ...
    addNotification({
      ...
      // timeout: 5000, // Duration before auto-dismiss (in milliseconds)
      // sound: 'path/to/sound/file.mp3', // Path to a custom sound file (if supported)
      vibrate: [200, 100, 200], // Vibration pattern (if supported)
      // badge: 'https://i.pinimg.com/564x/09/f6/6d/09f66d8e4b73391859d58f9f596cfb12.jpg', // Badge image (if supported)
